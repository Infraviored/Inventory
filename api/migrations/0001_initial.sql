...
CREATE INDEX IF NOT EXISTS idx_regions_location ON location_regions (location_id);
CREATE INDEX IF NOT EXISTS idx_items_location ON inventory_items (location_id);
CREATE INDEX IF NOT EXISTS idx_items_region ON inventory_items (region_id);
